## QEUR21_RLDQN2:　本実験～畳み込みRT法プラスDQN-ERでマインスイーパー(その2)
...
![imageRL2-26-1](https://QEUWIndValley.github.io/images/imageRL2-26-1.jpg)

D先生 ： “現状のスキームでは標準ベクトル1件と計測対象ベクトル1件の比較でやっているでしょ？**インプット情報は2件で、アウトプットのメトリックスは3件・・・。そのような変換は情報学上ありえない・・・。**”

![imageRL2-26-2](https://QEUWIndValley.github.io/images/imageRL2-26-2.jpg)
...
![imageRL2-26-3](https://QEUWIndValley.github.io/images/imageRL2-26-3.jpg)

**（パフォーマンス推移）**

![imageRL2-26-4](https://QEUWIndValley.github.io/images/imageRL2-26-4.jpg)

QEU:FOUNDER ： “ね・・・、いまいちでしょ？ちょっと無理な学習をさせているんじゃないかな？強調するけど、SOART法は外観検査自動機では使えますよ。Y2は使わないけど・・・。”

D先生 ： “SOARTメトリックスの2代目（SOART2）に期待ですね。”

![imageRL2-26-5](https://QEUWIndValley.github.io/images/imageRL2-26-5.jpg)

QEU:FOUNDER ： “一応は(新メトリックスの)アイデアはあります。やるかどうかはテーマに目組まれるか次第です。さあ・・・、マインスイーパーのプロジェクトの最後として、D先生の提案どおりに**「Eエリアを追加」**してやってみましょう。”

## ～　まとめ　～

C部長 : “ますます熱い・・・。イケメンバトルです。”

![imageRL2-26-6](https://QEUWIndValley.github.io/images/imageRL2-26-6.jpg)

D先生： “やっぱり、これでしょう・・・。”

<iframe width="560" height="315" src="https://www.youtube.com/embed/JzZgG9JKrYw" ti-tle="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; en-crypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

C部長 : “イケ麺（左）担当として、ちょっと矛盾を感じませんか？。”

D先生： “思いっきり感じた・・・（笑）。両方ともに私の担当だから・・・。”

![imageRL2-26-7](https://QEUWIndValley.github.io/images/imageRL2-26-7.jpg)
