## QEUR21_RL2048T32:　番外編～AAC（パターンRT法）で強制学習を使ってみた

## ～　念押しの念押し・・・、これは「趣味のコーナー」です　～

QEU:FOUNDER ： “ちょっと、先に「能書き」をやるよ・・・。”

D先生 ： “今回のシリーズはFOUNDERの趣味のコーナーなので、どうぞご自由に・・・（笑）。”

![imageRL1-32-1](https://QEUWIndValley.github.io/images/imageRL1-32-1.jpg)

QEU:FOUNDER ： “なぜ我々がAACで強制学習をやっているのかについて、話をしておきたいんです。普通のシーケンス型ロボットって、エンジニアが「ティーチング」をしますよね・・・。強制学習を通じて、強化学習で「それに相当するもの」をやってみたい・・・。”

D先生 ： “強化学習において、ロボットが「正しい手順をすぐに覚えてくれる」のは夢ですよね。強化学習は微調整用として学習してくれるという・・・。”

QEU:FOUNDER ： “そんな夢を複雑なゲーム2048でできるのかなぁ・・・。それではプログラムをドン！！”


```python
# ----------------
# 2048ゲームの強化学習システム
# step7 : パターンRT法を動的メトリックスとして活用する
# step7 : AAC_convRT_game2048_forced_agent.py
# step7 : AACとパターンRT法で強制学習後も強化学習します
# ---------------- 
# 数値計算のﾗｲﾌﾞﾗﾘ読み込み
import math
import numpy as np
...
QEU:FOUNDER ： “そして学習結果をドン・・・。自白するけど、失敗でした・・・。”

**(主要パフォーマンス)**

![imageRL1-32-2](https://QEUWIndValley.github.io/images/imageRL1-32-2.jpg)

**(その他のパフォーマンス)**

![imageRL1-32-3](https://QEUWIndValley.github.io/images/imageRL1-32-3.jpg)

D先生 ： “思いっきり、CRITICSの状態価値関数（V）が忘却されていますね（笑）。残念ですが、これは予見していたんで、開発はここまでにしましょう。”

QEU:FOUNDER ： “もっといい「黒魔術」があるかもしれません。あと、我々のプログラムにバグもあるかもしれないし・・・。”

D先生 ： “興味があるひとは、我々の戦略をヒントに自分でつづきをやってみてください。本音を言えば、状態価値関数を更新させなければいいんですよ・・・。”

QEU:FOUNDER ： “これが知識共有のあるべき姿ですね・・・（笑）。やっと、2048のシリーズが終わりました。マインスイーパーにいきましょう。”

## ～　まとめ　～

C部長 : “まだまだ継続は力なり、イケメン・バトルをやりましょう。”

![imageRL1-32-4](https://QEUWIndValley.github.io/images/imageRL1-32-4.jpg)

C部長 : “自分でいきます。ドン・・・。”

<iframe width="560" height="315" src="https://www.youtube.com/embed/AyCpS7jucPI?start=127" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

QEU:FOUNDER ： “（成長が）止まっとるやんけ・・・。”

![imageRL1-32-5](https://QEUWIndValley.github.io/images/imageRL1-32-5.jpg)

D先生 : “次なる大爆発のために、内なるエネルギーを貯めているんです・・・(小声)。”

C部長 : “なんで、こうなったんだろう・・・。”

D先生 : “「強み」の問題かァ・・・。人口は関西とは変わらないが、もっと経済が元気なTWという所があるでしょ？”

<iframe width="560" height="315" src="https://www.youtube.com/embed/3AV6ntFN8Lc" ti-tle="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; en-crypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

QEU:FOUNDER ： “きゃぁ！！経済解説がステキに強気だよね。R国はヘリウムをA国には売らないが、TWには売ってくれるだろう。我々が彼らに半導体を供給しているんだから・・・。そういえば、TWは敵性国家リストに入っていなかったっけ・・・。”

![imageRL1-32-6](https://QEUWIndValley.github.io/images/imageRL1-32-6.jpg)

QEU:FOUNDER ： “リストに「契丹」って書いてある・・・(笑)。やっぱり戦略物資の生産主導権を握っているのは強いよね・・・。”

D先生 : “昔は、関西って半導体が強かったのに・・・。なんで2000年代初めにやめちゃったんだろう・・・。”

![imageRL1-32-7](https://QEUWIndValley.github.io/images/imageRL1-32-7.jpg)

QEU:FOUNDER : “1990年代末、我らがエズさんの本（KAWAXI）に書いてあったよ。J国は工業生産を海外にシフトさせ、インバウンドを強化すべきだって・・・。その通りにしたんじゃないの？”
