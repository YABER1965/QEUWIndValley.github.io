...
#print(acc_mx_sigStep1)
# 単位空間の抽出
tensor_Y1Y2 = mx_taniStep1
# 畳み込みテンソルイメージを生成する
tani_image, signal_images = create_tsrConv(torch.tensor(tensor_Y1Y2).float())
# 畳み込みSOARTメトリックスを生成する
...
QEU:FOUNDER ： “今回も中間段階です。本来は特にいうことはないですが・・・。まずは、CSVファイルの出力結果から・・・。”

![imageRL3-25-2](https://QEUWIndValley.github.io/images/imageRL3-25-2.jpg)

QEU:FOUNDER ： “CSVファイルの中身はこんな感じです。”
...
QEU:FOUNDER ： “（我々は、）日々正しいことをするだけでいいのではないでしょうか。皆が正しいことをすれば、歴史はよくなる。皆が良くないことをすれば、歴史は悪くなるのでしょう。ちなみに、この動画（↑）で述べられた物語って、とてもダイナミックだと思いませんか？”
...
QEU:FOUNDER ： “先日、惜しくも亡くなった、**「あのお方」は大人物を目指したんだ**と思いますよ。彼の一族の先人がそうだったように・・・。でも、情報共有の時代に変わってしまっていて、昔のように「終わりよければすべてよし」にはならなくなったんですよね。ネガティブな情報をもみ消せばもみ消すほど、悪い方向に進んでしまった・・・。”
...
QEU:FOUNDER ： “だから、我々のイケメンも人物的なスケールは小さくなるが、日々正しいことをするだけでいいのではないでしょうか。あまり大きなことをすると、情報流通がケタ違いの現代では逆効果ではないかと・・・。ヨハネ福音書のラザロは小人物ですが、正教会では聖人と扱われています。”

D先生 : “ヨハネ福音書によれば、偉大なことをすることが人間の価値ではない。正しいことをすることがより重要なのだと・・・・。”

C部長 : “あれ？D先生が担当していたイケメンがなぜか**「NOT　FOUND」**なっています。”

QEU:FOUNDER ： “大人物を目指しすぎて、多少無理をし過ぎではないかと・・・。”

D先生 : “真ん中のイケメンのように、「可視化をします」といっているのは最も賢いやり方ですね。”
